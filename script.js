...
class Raven {
    ...
    update(deltaTime){
        ...
        if(this.timeSinceFlap > this.flapInterval) {
            ...
            if(this.hasTrail){
                for (let i = 0; i < 5; i++) {
                    particles.push(new Particle(this.x, 
                        this.y, 
                        this.width, 
                        this.color));                    
                }
...
function drawGameOver(){
    ...
    ctx.fillStyle = 'white';
    ctx.fillText('GAME OVER, your score is ' + score, 
                canvas.width/2+5, canvas.height/2+5);
}
...
function animate(timestamp){
    ...
    lastTime = timestamp;    
    timeSinceLastRaven += deltaTime;
    if (timeSinceLastRaven > ravenInterval) {
        ravens.push(new Raven());
        timeSinceLastRaven = 0;  
