...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: '6eb4d8f3b80748b9b4c6f261985d431b',
        src: joke,
        hl: 'en-au',
        v: 'Evie',
        r: 0, 
...
async function typeText() {
    ...
    for (let i = 0; i < joke.length; i++) {
        typewriter.innerText = joke.substring(0,i);
        await timer(50);
    }    
}
...
audioElement.addEventListener('ended', unTypeText);
audioElement.addEventListener('play', typeText);