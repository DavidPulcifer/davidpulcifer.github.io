window.addEventListener('load', function(){
    ...
    function displayStatusText(context){
        ...
        context.fillText('Score: ' + score + "          ↑ Jump     ← Move →", 20, 50);
        context.fillStyle = 'white';
        context.fillText('Score: ' + score + "          ↑ Jump     ← Move →", 22, 51);
        if(gameOver) {
            context.textAlign = 'center';
            context.fillStyle = 'black';
            context.fillText('GAME OVER, press Enter or swipe down to restart!', canvas.width/2, 200);
            context.fillStyle = 'white';
            context.fillText('GAME OVER, press Enter or swipe down to restart!', canvas.width/2 + 2, 201);
        }
    }
