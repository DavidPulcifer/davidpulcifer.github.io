...
export class Player {
    ...
    update(input, deltaTime){
        ...
        if(input.includes('ArrowRight') && 
            ...
            !this.game.paused) this.speed = this.maxSpeed;
    ...
    setState(state, speed){
        ...
        if(diffDropdown.value === 'medium' || diffDropdown.value === 'hard'){
            this.game.enemyInterval = 2000 / speed;
        }
        ...
        this.game.enemies.forEach(enemy => {
            if(enemy.x < this.x + (this.width-20) &&
                ...
                if(this.currentState === this.states[4] ||
                    ...
                    this.game.score++;
                    this.game.floatingMessages.push(new FloatingMessages('+1', 
                                                                        enemy.x, enemy.y,
                                                                        90, 50));
                } else {
                    this.setState(6, 0);
